...
If github rendering for jupyter notebook is not working, you can always view scraper.ipynb with [nbviewer](https://nbviewer.jupyter.org/github/recinosj/jupyter-notebook-python/blob/master/ufc/scraper.ipynb)
...
If github rendering for jupyter notebook is not working, you can always view ufc.ipynb with [nbviewer](https://nbviewer.jupyter.org/github/recinosj/jupyter-notebook-python/blob/master/ufc/ufc.ipynb)
